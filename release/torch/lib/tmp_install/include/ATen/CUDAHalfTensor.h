...
struct CUDAHalfTensor final : public TensorImpl {
public:
  explicit CUDAHalfTensor(Context* context);
  CUDAHalfTensor(Context* context, THCudaHalfTensor * tensor);
  virtual ~CUDAHalfTensor();
