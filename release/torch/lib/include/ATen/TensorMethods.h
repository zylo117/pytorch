...
inline Tensor & Tensor::_fill_(Scalar value) {
    return type()._fill_(*this, value);
}
inline Tensor & Tensor::_fill_(const Tensor & value) {
    return type()._fill_(*this, value);
}
...
inline Tensor Tensor::_log10() const {
    return type()._log10(*this);
}
inline Tensor Tensor::_log1p() const {
    return type()._log1p(*this);
}
inline Tensor Tensor::_log2() const {
    return type()._log2(*this);
}
...
inline Tensor Tensor::_expm1() const {
    return type()._expm1(*this);
}
inline Tensor Tensor::_cos() const {
    return type()._cos(*this);
}
inline Tensor Tensor::_acos() const {
    return type()._acos(*this);
}
inline Tensor Tensor::_cosh() const {
    return type()._cosh(*this);
}
inline Tensor Tensor::_sin() const {
    return type()._sin(*this);
}
inline Tensor Tensor::_asin() const {
    return type()._asin(*this);
}
inline Tensor Tensor::_sinh() const {
    return type()._sinh(*this);
}
inline Tensor Tensor::_tan() const {
    return type()._tan(*this);
}
inline Tensor Tensor::_atan() const {
    return type()._atan(*this);
}
inline Tensor Tensor::_th_tanh() const {
    return type()._th_tanh(*this);
}
inline Tensor Tensor::_erf() const {
    return type()._erf(*this);
}
...
inline Tensor Tensor::_rsqrt() const {
    return type()._rsqrt(*this);
}
...
inline Tensor Tensor::_th_sum(int64_t dim, bool keepdim) const {
    return type()._th_sum(*this, dim, keepdim);
}
inline Tensor Tensor::_prodall() const {
    return type()._prodall(*this);
}
inline Tensor Tensor::_th_prod(int64_t dim, bool keepdim) const {
    return type()._th_prod(*this, dim, keepdim);
}
inline Tensor Tensor::_cumsum(int64_t dim) const {
    return type()._cumsum(*this, dim);
}
inline Tensor Tensor::_cumprod(int64_t dim) const {
    return type()._cumprod(*this, dim);
}
...
inline std::tuple<Tensor,Tensor> Tensor::_gesv_single(const Tensor & A) const {
    return type()._gesv_single(*this, A);
}
...
inline Tensor Tensor::_th_bernoulli(Generator * generator) const {
    return type()._th_bernoulli(*this, generator);
}
...
inline std::tuple<Tensor,Tensor> Tensor::_gesv_helper(const Tensor & A) const {
    return type()._gesv_helper(*this, A);
}
...
inline Tensor Tensor::log_softmax_backward_data(const Tensor & grad_output, const Tensor & output, int64_t dim) const {
    return type().log_softmax_backward_data(grad_output, output, dim, *this);
}
...
inline Tensor Tensor::softmax_backward_data(const Tensor & grad_output, const Tensor & output, int64_t dim) const {
    return type().softmax_backward_data(grad_output, output, dim, *this);
}
...
inline Tensor Tensor::_sum() const {
    return type()._sum(*this);
}
...
inline Tensor Tensor::_sum(IntList dim, bool keepdim) const {
...
inline Tensor Tensor::_prod() const {
    return type()._prod(*this);
}
