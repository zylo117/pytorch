...
struct Tensor : public detail::TensorBase {
  ...
  Tensor _cast_uint8_t(bool non_blocking=false) const;
  Tensor _cast_int8_t(bool non_blocking=false) const;
  ...
  Tensor _cast_int64_t(bool non_blocking=false) const;
  Tensor _cast_int16_t(bool non_blocking=false) const;
  ...
  Tensor stft(int64_t frame_length, int64_t hop, int64_t fft_size, bool normalized=false, bool onesided=true, const Tensor & window={}, int64_t pad_end=0) const;
