...
struct CPULongTensor final : public TensorImpl {
public:
  explicit CPULongTensor(Context* context);
  CPULongTensor(Context* context, THLongTensor * tensor);
  virtual ~CPULongTensor();
