...
struct AT_API Type {
  ...
  virtual Tensor & _fill_(Tensor & self, Scalar value) const;
  virtual Tensor & _fill_(Tensor & self, const Tensor & value) const;
  ...
  virtual Tensor & all_out(Tensor & result, const Tensor & self, int64_t dim, bool keepdim=false) const;
  virtual Tensor all(const Tensor & self, int64_t dim, bool keepdim=false) const;
  virtual Tensor all(const Tensor & self) const;
  virtual Tensor & any_out(Tensor & result, const Tensor & self, int64_t dim, bool keepdim=false) const;
  virtual Tensor any(const Tensor & self, int64_t dim, bool keepdim=false) const;
  ...
  virtual Tensor & _log10_out(Tensor & result, const Tensor & self) const;
  virtual Tensor _log10(const Tensor & self) const;
  virtual Tensor & _log1p_out(Tensor & result, const Tensor & self) const;
  virtual Tensor _log1p(const Tensor & self) const;
  virtual Tensor & _log2_out(Tensor & result, const Tensor & self) const;
  virtual Tensor _log2(const Tensor & self) const;
  ...
  virtual Tensor & _expm1_out(Tensor & result, const Tensor & self) const;
  virtual Tensor _expm1(const Tensor & self) const;
  virtual Tensor & _cos_out(Tensor & result, const Tensor & self) const;
  virtual Tensor _cos(const Tensor & self) const;
  virtual Tensor & _acos_out(Tensor & result, const Tensor & self) const;
  virtual Tensor _acos(const Tensor & self) const;
  virtual Tensor & _cosh_out(Tensor & result, const Tensor & self) const;
  virtual Tensor _cosh(const Tensor & self) const;
  virtual Tensor & _sin_out(Tensor & result, const Tensor & self) const;
  virtual Tensor _sin(const Tensor & self) const;
  virtual Tensor & _asin_out(Tensor & result, const Tensor & self) const;
  virtual Tensor _asin(const Tensor & self) const;
  virtual Tensor & _sinh_out(Tensor & result, const Tensor & self) const;
  virtual Tensor _sinh(const Tensor & self) const;
  virtual Tensor & _tan_out(Tensor & result, const Tensor & self) const;
  virtual Tensor _tan(const Tensor & self) const;
  virtual Tensor & _atan_out(Tensor & result, const Tensor & self) const;
  virtual Tensor _atan(const Tensor & self) const;
  virtual Tensor & _th_tanh_out(Tensor & result, const Tensor & self) const;
  virtual Tensor _th_tanh(const Tensor & self) const;
  virtual Tensor & _erf_out(Tensor & result, const Tensor & self) const;
  virtual Tensor _erf(const Tensor & self) const;
  ...
  virtual Tensor & _rsqrt_out(Tensor & result, const Tensor & self) const;
  virtual Tensor _rsqrt(const Tensor & self) const;
  ...
  virtual std::tuple<Tensor &,Tensor &> _gesv_single_out(Tensor & solution, Tensor & lu, const Tensor & self, const Tensor & A) const;
  virtual std::tuple<Tensor,Tensor> _gesv_single(const Tensor & self, const Tensor & A) const;
  ...
  virtual Tensor & _th_bernoulli_out(Tensor & output, const Tensor & self, Generator * generator=nullptr) const;
  virtual Tensor _th_bernoulli(const Tensor & self, Generator * generator=nullptr) const;
  ...
  virtual Tensor bernoulli(const Tensor & self, const Tensor & p, Generator * generator=nullptr) const;
  virtual Tensor bernoulli(const Tensor & self, double p, Generator * generator=nullptr) const;
  virtual Tensor bernoulli(const Tensor & self) const;
  ...
  virtual Tensor & bernoulli_(Tensor & self) const;
  ...
  virtual Tensor diagonal(const Tensor & self, int64_t offset=0, int64_t dim1=0, int64_t dim2=1) const;
  virtual Tensor dot(const Tensor & self, const Tensor & tensor) const;
  virtual Tensor & dot_out(Tensor & result, const Tensor & self, const Tensor & tensor) const;
  ...
  virtual std::tuple<Tensor,Tensor,Tensor,Tensor> embedding_bag(const Tensor & weight, const Tensor & indices, const Tensor & offsets, bool scale_grad_by_freq=false, int64_t mode=0, bool sparse=false) const;
  virtual Tensor embedding_bag_backward(const Tensor & grad, const Tensor & indices, const Tensor & offsets, const Tensor & offset2bag, const Tensor & bag_size, const Tensor & maximum_indices, int64_t num_weights, bool scale_grad_by_freq, int64_t mode, bool sparse) const;
  ...
  virtual Tensor embedding_bag_dense_backward(const Tensor & grad, const Tensor & indices, const Tensor & offsets, const Tensor & offset2bag, const Tensor & bag_size, const Tensor & maximum_indices, int64_t num_weights, bool scale_grad_by_freq, int64_t mode) const;
  ...
  virtual Tensor expand(const Tensor & self, IntList size, bool implicit=false) const;
  ...
  virtual std::tuple<Tensor,Tensor> _gesv_helper(const Tensor & self, const Tensor & A) const;
  ...
  virtual Tensor log_softmax_backward_data(const Tensor & grad_output, const Tensor & output, int64_t dim, const Tensor & self) const;
  virtual Tensor logsumexp(const Tensor & self, int64_t dim, bool keepdim=false) const;
  virtual Tensor & logsumexp_out(Tensor & result, const Tensor & self, int64_t dim, bool keepdim=false) const;
  ...
  virtual Tensor & matmul_out(Tensor & result, const Tensor & self, const Tensor & other) const;
  ...
  virtual Tensor softmax_backward_data(const Tensor & grad_output, const Tensor & output, int64_t dim, const Tensor & self) const;
  ...
  virtual Tensor sum(const Tensor & self, IntList dim, bool keepdim, ScalarType dtype) const;
  virtual Tensor sum(const Tensor & self, IntList dim, bool keepdim=false) const;
  virtual Tensor sum(const Tensor & self, IntList dim, ScalarType dtype) const;
  virtual Tensor _sum(const Tensor & self, IntList dim, bool keepdim=false) const;
  virtual Tensor & sum_out(Tensor & result, const Tensor & self, IntList dim, bool keepdim, ScalarType dtype) const;
  virtual Tensor & sum_out(Tensor & result, const Tensor & self, IntList dim, bool keepdim=false) const;
  virtual Tensor & sum_out(Tensor & result, const Tensor & self, IntList dim, ScalarType dtype) const;
  virtual Tensor & _sum_out(Tensor & result, const Tensor & self, IntList dim, bool keepdim=false) const;
  virtual Tensor & _sum_cuda_out(Tensor & result, const Tensor & self, int64_t dim, bool keepdim=false) const;
