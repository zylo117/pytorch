...
PyObject * FloatMultiMarginCriterion_updateOutput(PyObject *_unused, PyObject *args)
{
  ...
  int __argcount = args ? PyTuple_Size(args) : 0;
    ...
    if (__argcount == 9 &&
      ...
      try {
        Py_UNBLOCK_THREADS;
        THNN_FloatMultiMarginCriterion_updateOutput(arg_state, arg_input, arg_target, arg_output, arg_sizeAverage, arg_p, arg_weights, arg_margin, arg_reduce);
        Py_BLOCK_THREADS;
        Py_RETURN_NONE;
      } catch (...) {
        if (_save) {
    ...
    THPUtils_invalidArguments(args, NULL, "FloatMultiMarginCriterion_updateOutput", 1, "(int state, torch.FloatTensor input, torch.LongTensor target, torch.FloatTensor output, bool sizeAverage, int p, [torch.FloatTensor weights or None], float margin, bool reduce)");
    return NULL;
  }
  END_HANDLE_TH_ERRORS
}
...
PyObject * DoubleMultiMarginCriterion_updateOutput(PyObject *_unused, PyObject *args)
{
  ...
  int __argcount = args ? PyTuple_Size(args) : 0;
    ...
    if (__argcount == 9 &&
      ...
      try {
        Py_UNBLOCK_THREADS;
        THNN_DoubleMultiMarginCriterion_updateOutput(arg_state, arg_input, arg_target, arg_output, arg_sizeAverage, arg_p, arg_weights, arg_margin, arg_reduce);
        Py_BLOCK_THREADS;
        Py_RETURN_NONE;
      } catch (...) {
        if (_save) {
    ...
    THPUtils_invalidArguments(args, NULL, "DoubleMultiMarginCriterion_updateOutput", 1, "(int state, torch.DoubleTensor input, torch.LongTensor target, torch.DoubleTensor output, bool sizeAverage, int p, [torch.DoubleTensor weights or None], float margin, bool reduce)");
    return NULL;
  }
  END_HANDLE_TH_ERRORS
}
...
PyObject * FloatMultiMarginCriterion_updateGradInput(PyObject *_unused, PyObject *args)
{
  ...
  int __argcount = args ? PyTuple_Size(args) : 0;
    ...
    if (__argcount == 10 &&
      ...
      try {
        Py_UNBLOCK_THREADS;
        THNN_FloatMultiMarginCriterion_updateGradInput(arg_state, arg_input, arg_target, arg_gradOutput, arg_gradInput, arg_sizeAverage, arg_p, arg_weights, arg_margin, arg_reduce);
        Py_BLOCK_THREADS;
        Py_RETURN_NONE;
      } catch (...) {
        if (_save) {
    ...
    THPUtils_invalidArguments(args, NULL, "FloatMultiMarginCriterion_updateGradInput", 1, "(int state, torch.FloatTensor input, torch.LongTensor target, torch.FloatTensor gradOutput, torch.FloatTensor gradInput, bool sizeAverage, int p, [torch.FloatTensor weights or None], float margin, bool reduce)");
    return NULL;
  }
  END_HANDLE_TH_ERRORS
}
...
PyObject * DoubleMultiMarginCriterion_updateGradInput(PyObject *_unused, PyObject *args)
{
  ...
  int __argcount = args ? PyTuple_Size(args) : 0;
    ...
    if (__argcount == 10 &&
      ...
      try {
        Py_UNBLOCK_THREADS;
        THNN_DoubleMultiMarginCriterion_updateGradInput(arg_state, arg_input, arg_target, arg_gradOutput, arg_gradInput, arg_sizeAverage, arg_p, arg_weights, arg_margin, arg_reduce);
        Py_BLOCK_THREADS;
        Py_RETURN_NONE;
      } catch (...) {
        if (_save) {
    ...
    THPUtils_invalidArguments(args, NULL, "DoubleMultiMarginCriterion_updateGradInput", 1, "(int state, torch.DoubleTensor input, torch.LongTensor target, torch.DoubleTensor gradOutput, torch.DoubleTensor gradInput, bool sizeAverage, int p, [torch.DoubleTensor weights or None], float margin, bool reduce)");
    return NULL;
  }
  END_HANDLE_TH_ERRORS
}
...
PyObject * FloatVolumetricGridSamplerBilinear_updateOutput(PyObject *_unused, PyObject *args)
{
  HANDLE_TH_ERRORS
  int __argcount = args ? PyTuple_Size(args) : 0;
    ...
    if (__argcount == 5 &&
      ...
      try {
        Py_UNBLOCK_THREADS;
        THNN_FloatVolumetricGridSamplerBilinear_updateOutput(arg_state, arg_input, arg_grid, arg_output, arg_padding_mode);
        Py_BLOCK_THREADS;
        Py_RETURN_NONE;
      } catch (...) {
        if (_save) {
    ...
    THPUtils_invalidArguments(args, NULL, "FloatVolumetricGridSamplerBilinear_updateOutput", 1, "(int state, torch.FloatTensor input, torch.FloatTensor grid, torch.FloatTensor output, int padding_mode)");
    return NULL;
  }
  END_HANDLE_TH_ERRORS
}
...
PyObject * DoubleVolumetricGridSamplerBilinear_updateOutput(PyObject *_unused, PyObject *args)
{
  HANDLE_TH_ERRORS
  int __argcount = args ? PyTuple_Size(args) : 0;
    ...
    if (__argcount == 5 &&
      ...
      try {
        Py_UNBLOCK_THREADS;
        THNN_DoubleVolumetricGridSamplerBilinear_updateOutput(arg_state, arg_input, arg_grid, arg_output, arg_padding_mode);
        Py_BLOCK_THREADS;
        Py_RETURN_NONE;
      } catch (...) {
        if (_save) {
    ...
    THPUtils_invalidArguments(args, NULL, "DoubleVolumetricGridSamplerBilinear_updateOutput", 1, "(int state, torch.DoubleTensor input, torch.DoubleTensor grid, torch.DoubleTensor output, int padding_mode)");
    return NULL;
  }
  END_HANDLE_TH_ERRORS
}
...
PyObject * FloatVolumetricGridSamplerBilinear_updateGradInput(PyObject *_unused, PyObject *args)
{
  HANDLE_TH_ERRORS
  int __argcount = args ? PyTuple_Size(args) : 0;
    ...
    if (__argcount == 7 &&
      ...
      try {
        Py_UNBLOCK_THREADS;
        THNN_FloatVolumetricGridSamplerBilinear_updateGradInput(arg_state, arg_input, arg_gradInput, arg_grid, arg_gradGrid, arg_gradOutput, arg_padding_mode);
        Py_BLOCK_THREADS;
        Py_RETURN_NONE;
      } catch (...) {
        if (_save) {
    ...
    THPUtils_invalidArguments(args, NULL, "FloatVolumetricGridSamplerBilinear_updateGradInput", 1, "(int state, torch.FloatTensor input, torch.FloatTensor gradInput, torch.FloatTensor grid, torch.FloatTensor gradGrid, torch.FloatTensor gradOutput, int padding_mode)");
    return NULL;
  }
  END_HANDLE_TH_ERRORS
}
...
PyObject * DoubleVolumetricGridSamplerBilinear_updateGradInput(PyObject *_unused, PyObject *args)
{
  HANDLE_TH_ERRORS
  int __argcount = args ? PyTuple_Size(args) : 0;
    ...
    if (__argcount == 7 &&
      ...
      try {
        Py_UNBLOCK_THREADS;
        THNN_DoubleVolumetricGridSamplerBilinear_updateGradInput(arg_state, arg_input, arg_gradInput, arg_grid, arg_gradGrid, arg_gradOutput, arg_padding_mode);
        Py_BLOCK_THREADS;
        Py_RETURN_NONE;
      } catch (...) {
        if (_save) {
    ...
    THPUtils_invalidArguments(args, NULL, "DoubleVolumetricGridSamplerBilinear_updateGradInput", 1, "(int state, torch.DoubleTensor input, torch.DoubleTensor gradInput, torch.DoubleTensor grid, torch.DoubleTensor gradGrid, torch.DoubleTensor gradOutput, int padding_mode)");
    return NULL;
  }
  END_HANDLE_TH_ERRORS
}
...
static PyMethodDef module_methods[] = {
  {"FloatAbs_updateOutput", (PyCFunction)FloatAbs_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleAbs_updateOutput", (PyCFunction)DoubleAbs_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatAbs_updateGradInput", (PyCFunction)FloatAbs_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleAbs_updateGradInput", (PyCFunction)DoubleAbs_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  ...
  {"FloatDistKLDivCriterion_updateOutput", (PyCFunction)FloatDistKLDivCriterion_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleDistKLDivCriterion_updateOutput", (PyCFunction)DoubleDistKLDivCriterion_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatDistKLDivCriterion_updateGradInput", (PyCFunction)FloatDistKLDivCriterion_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleDistKLDivCriterion_updateGradInput", (PyCFunction)DoubleDistKLDivCriterion_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  ...
  {"FloatHardShrink_updateOutput", (PyCFunction)FloatHardShrink_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleHardShrink_updateOutput", (PyCFunction)DoubleHardShrink_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatHardShrink_updateGradInput", (PyCFunction)FloatHardShrink_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleHardShrink_updateGradInput", (PyCFunction)DoubleHardShrink_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  ...
  {"FloatL1Cost_updateOutput", (PyCFunction)FloatL1Cost_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleL1Cost_updateOutput", (PyCFunction)DoubleL1Cost_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatL1Cost_updateGradInput", (PyCFunction)FloatL1Cost_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleL1Cost_updateGradInput", (PyCFunction)DoubleL1Cost_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  ...
  {"FloatGRUFused_updateOutput", (PyCFunction)FloatGRUFused_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleGRUFused_updateOutput", (PyCFunction)DoubleGRUFused_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatGRUFused_updateGradInput", (PyCFunction)FloatGRUFused_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleGRUFused_updateGradInput", (PyCFunction)DoubleGRUFused_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatLSTMFused_updateOutput", (PyCFunction)FloatLSTMFused_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleLSTMFused_updateOutput", (PyCFunction)DoubleLSTMFused_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatLSTMFused_updateGradInput", (PyCFunction)FloatLSTMFused_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleLSTMFused_updateGradInput", (PyCFunction)DoubleLSTMFused_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  ...
  {"FloatLookupTable_accGradParameters", (PyCFunction)FloatLookupTable_accGradParameters, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleLookupTable_accGradParameters", (PyCFunction)DoubleLookupTable_accGradParameters, METH_STATIC | METH_VARARGS, NULL},
  {"FloatLookupTable_renorm", (PyCFunction)FloatLookupTable_renorm, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleLookupTable_renorm", (PyCFunction)DoubleLookupTable_renorm, METH_STATIC | METH_VARARGS, NULL},
  {"FloatMarginCriterion_updateOutput", (PyCFunction)FloatMarginCriterion_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleMarginCriterion_updateOutput", (PyCFunction)DoubleMarginCriterion_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatMarginCriterion_updateGradInput", (PyCFunction)FloatMarginCriterion_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleMarginCriterion_updateGradInput", (PyCFunction)DoubleMarginCriterion_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  ...
  {"FloatPReLU_updateOutput", (PyCFunction)FloatPReLU_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"DoublePReLU_updateOutput", (PyCFunction)DoublePReLU_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatPReLU_updateGradInput", (PyCFunction)FloatPReLU_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"DoublePReLU_updateGradInput", (PyCFunction)DoublePReLU_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatPReLU_accGradParameters", (PyCFunction)FloatPReLU_accGradParameters, METH_STATIC | METH_VARARGS, NULL},
  {"DoublePReLU_accGradParameters", (PyCFunction)DoublePReLU_accGradParameters, METH_STATIC | METH_VARARGS, NULL},
  {"FloatLinear_updateOutput", (PyCFunction)FloatLinear_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleLinear_updateOutput", (PyCFunction)DoubleLinear_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatLinear_updateGradInput", (PyCFunction)FloatLinear_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleLinear_updateGradInput", (PyCFunction)DoubleLinear_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatLinear_accGradParameters", (PyCFunction)FloatLinear_accGradParameters, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleLinear_accGradParameters", (PyCFunction)DoubleLinear_accGradParameters, METH_STATIC | METH_VARARGS, NULL},
  ...
  {"FloatSqrt_updateOutput", (PyCFunction)FloatSqrt_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleSqrt_updateOutput", (PyCFunction)DoubleSqrt_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatSqrt_updateGradInput", (PyCFunction)FloatSqrt_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleSqrt_updateGradInput", (PyCFunction)DoubleSqrt_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatSquare_updateOutput", (PyCFunction)FloatSquare_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleSquare_updateOutput", (PyCFunction)DoubleSquare_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatSquare_updateGradInput", (PyCFunction)FloatSquare_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleSquare_updateGradInput", (PyCFunction)DoubleSquare_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  ...
  {"FloatThreshold_updateOutput", (PyCFunction)FloatThreshold_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleThreshold_updateOutput", (PyCFunction)DoubleThreshold_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatThreshold_updateGradInput", (PyCFunction)FloatThreshold_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleThreshold_updateGradInput", (PyCFunction)DoubleThreshold_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatTemporalConvolution_updateOutput", (PyCFunction)FloatTemporalConvolution_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleTemporalConvolution_updateOutput", (PyCFunction)DoubleTemporalConvolution_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatTemporalConvolution_updateGradInput", (PyCFunction)FloatTemporalConvolution_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleTemporalConvolution_updateGradInput", (PyCFunction)DoubleTemporalConvolution_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatTemporalConvolution_accGradParameters", (PyCFunction)FloatTemporalConvolution_accGradParameters, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleTemporalConvolution_accGradParameters", (PyCFunction)DoubleTemporalConvolution_accGradParameters, METH_STATIC | METH_VARARGS, NULL},
  {"FloatTemporalMaxPooling_updateOutput", (PyCFunction)FloatTemporalMaxPooling_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleTemporalMaxPooling_updateOutput", (PyCFunction)DoubleTemporalMaxPooling_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatTemporalMaxPooling_updateGradInput", (PyCFunction)FloatTemporalMaxPooling_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleTemporalMaxPooling_updateGradInput", (PyCFunction)DoubleTemporalMaxPooling_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatTemporalSubSampling_updateOutput", (PyCFunction)FloatTemporalSubSampling_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleTemporalSubSampling_updateOutput", (PyCFunction)DoubleTemporalSubSampling_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatTemporalSubSampling_updateGradInput", (PyCFunction)FloatTemporalSubSampling_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleTemporalSubSampling_updateGradInput", (PyCFunction)DoubleTemporalSubSampling_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatTemporalSubSampling_accGradParameters", (PyCFunction)FloatTemporalSubSampling_accGradParameters, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleTemporalSubSampling_accGradParameters", (PyCFunction)DoubleTemporalSubSampling_accGradParameters, METH_STATIC | METH_VARARGS, NULL},
  ...
  {"FloatBatchNormalization_updateOutput", (PyCFunction)FloatBatchNormalization_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleBatchNormalization_updateOutput", (PyCFunction)DoubleBatchNormalization_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatBatchNormalization_backward", (PyCFunction)FloatBatchNormalization_backward, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleBatchNormalization_backward", (PyCFunction)DoubleBatchNormalization_backward, METH_STATIC | METH_VARARGS, NULL},
  {"FloatSpatialConvolutionMap_updateOutput", (PyCFunction)FloatSpatialConvolutionMap_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleSpatialConvolutionMap_updateOutput", (PyCFunction)DoubleSpatialConvolutionMap_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatSpatialConvolutionMap_updateGradInput", (PyCFunction)FloatSpatialConvolutionMap_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleSpatialConvolutionMap_updateGradInput", (PyCFunction)DoubleSpatialConvolutionMap_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatSpatialConvolutionMap_accGradParameters", (PyCFunction)FloatSpatialConvolutionMap_accGradParameters, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleSpatialConvolutionMap_accGradParameters", (PyCFunction)DoubleSpatialConvolutionMap_accGradParameters, METH_STATIC | METH_VARARGS, NULL},
  ...
  {"FloatSpatialConvolutionLocal_updateOutput", (PyCFunction)FloatSpatialConvolutionLocal_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleSpatialConvolutionLocal_updateOutput", (PyCFunction)DoubleSpatialConvolutionLocal_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatSpatialConvolutionLocal_updateGradInput", (PyCFunction)FloatSpatialConvolutionLocal_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleSpatialConvolutionLocal_updateGradInput", (PyCFunction)DoubleSpatialConvolutionLocal_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatSpatialConvolutionLocal_accGradParameters", (PyCFunction)FloatSpatialConvolutionLocal_accGradParameters, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleSpatialConvolutionLocal_accGradParameters", (PyCFunction)DoubleSpatialConvolutionLocal_accGradParameters, METH_STATIC | METH_VARARGS, NULL},
  ...
  {"FloatSpatialFullConvolution_updateOutput", (PyCFunction)FloatSpatialFullConvolution_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleSpatialFullConvolution_updateOutput", (PyCFunction)DoubleSpatialFullConvolution_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatSpatialFullConvolution_updateGradInput", (PyCFunction)FloatSpatialFullConvolution_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleSpatialFullConvolution_updateGradInput", (PyCFunction)DoubleSpatialFullConvolution_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatSpatialFullConvolution_accGradParameters", (PyCFunction)FloatSpatialFullConvolution_accGradParameters, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleSpatialFullConvolution_accGradParameters", (PyCFunction)DoubleSpatialFullConvolution_accGradParameters, METH_STATIC | METH_VARARGS, NULL},
  {"FloatSpatialFullConvolutionMap_updateOutput", (PyCFunction)FloatSpatialFullConvolutionMap_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleSpatialFullConvolutionMap_updateOutput", (PyCFunction)DoubleSpatialFullConvolutionMap_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatSpatialFullConvolutionMap_updateGradInput", (PyCFunction)FloatSpatialFullConvolutionMap_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleSpatialFullConvolutionMap_updateGradInput", (PyCFunction)DoubleSpatialFullConvolutionMap_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatSpatialFullConvolutionMap_accGradParameters", (PyCFunction)FloatSpatialFullConvolutionMap_accGradParameters, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleSpatialFullConvolutionMap_accGradParameters", (PyCFunction)DoubleSpatialFullConvolutionMap_accGradParameters, METH_STATIC | METH_VARARGS, NULL},
  ...
  {"FloatSpatialMaxPooling_updateOutput", (PyCFunction)FloatSpatialMaxPooling_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleSpatialMaxPooling_updateOutput", (PyCFunction)DoubleSpatialMaxPooling_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatSpatialMaxPooling_updateGradInput", (PyCFunction)FloatSpatialMaxPooling_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleSpatialMaxPooling_updateGradInput", (PyCFunction)DoubleSpatialMaxPooling_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  ...
  {"FloatSpatialSubSampling_updateOutput", (PyCFunction)FloatSpatialSubSampling_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleSpatialSubSampling_updateOutput", (PyCFunction)DoubleSpatialSubSampling_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatSpatialSubSampling_updateGradInput", (PyCFunction)FloatSpatialSubSampling_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleSpatialSubSampling_updateGradInput", (PyCFunction)DoubleSpatialSubSampling_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatSpatialSubSampling_accGradParameters", (PyCFunction)FloatSpatialSubSampling_accGradParameters, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleSpatialSubSampling_accGradParameters", (PyCFunction)DoubleSpatialSubSampling_accGradParameters, METH_STATIC | METH_VARARGS, NULL},
  ...
  {"FloatSpatialGridSamplerBilinear_updateOutput", (PyCFunction)FloatSpatialGridSamplerBilinear_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleSpatialGridSamplerBilinear_updateOutput", (PyCFunction)DoubleSpatialGridSamplerBilinear_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatSpatialGridSamplerBilinear_updateGradInput", (PyCFunction)FloatSpatialGridSamplerBilinear_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleSpatialGridSamplerBilinear_updateGradInput", (PyCFunction)DoubleSpatialGridSamplerBilinear_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatVolumetricGridSamplerBilinear_updateOutput", (PyCFunction)FloatVolumetricGridSamplerBilinear_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleVolumetricGridSamplerBilinear_updateOutput", (PyCFunction)DoubleVolumetricGridSamplerBilinear_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatVolumetricGridSamplerBilinear_updateGradInput", (PyCFunction)FloatVolumetricGridSamplerBilinear_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleVolumetricGridSamplerBilinear_updateGradInput", (PyCFunction)DoubleVolumetricGridSamplerBilinear_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  ...
  {"FloatVolumetricConvolution_updateOutput", (PyCFunction)FloatVolumetricConvolution_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleVolumetricConvolution_updateOutput", (PyCFunction)DoubleVolumetricConvolution_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatVolumetricConvolution_updateGradInput", (PyCFunction)FloatVolumetricConvolution_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleVolumetricConvolution_updateGradInput", (PyCFunction)DoubleVolumetricConvolution_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatVolumetricConvolution_accGradParameters", (PyCFunction)FloatVolumetricConvolution_accGradParameters, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleVolumetricConvolution_accGradParameters", (PyCFunction)DoubleVolumetricConvolution_accGradParameters, METH_STATIC | METH_VARARGS, NULL},
  ...
  {"FloatVolumetricFractionalMaxPooling_updateOutput", (PyCFunction)FloatVolumetricFractionalMaxPooling_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleVolumetricFractionalMaxPooling_updateOutput", (PyCFunction)DoubleVolumetricFractionalMaxPooling_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatVolumetricFractionalMaxPooling_updateGradInput", (PyCFunction)FloatVolumetricFractionalMaxPooling_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleVolumetricFractionalMaxPooling_updateGradInput", (PyCFunction)DoubleVolumetricFractionalMaxPooling_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatVolumetricFullConvolution_updateOutput", (PyCFunction)FloatVolumetricFullConvolution_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleVolumetricFullConvolution_updateOutput", (PyCFunction)DoubleVolumetricFullConvolution_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatVolumetricFullConvolution_updateGradInput", (PyCFunction)FloatVolumetricFullConvolution_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleVolumetricFullConvolution_updateGradInput", (PyCFunction)DoubleVolumetricFullConvolution_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatVolumetricFullConvolution_accGradParameters", (PyCFunction)FloatVolumetricFullConvolution_accGradParameters, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleVolumetricFullConvolution_accGradParameters", (PyCFunction)DoubleVolumetricFullConvolution_accGradParameters, METH_STATIC | METH_VARARGS, NULL},
  ...
  {"FloatVolumetricMaxPooling_updateOutput", (PyCFunction)FloatVolumetricMaxPooling_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleVolumetricMaxPooling_updateOutput", (PyCFunction)DoubleVolumetricMaxPooling_updateOutput, METH_STATIC | METH_VARARGS, NULL},
  {"FloatVolumetricMaxPooling_updateGradInput", (PyCFunction)FloatVolumetricMaxPooling_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
  {"DoubleVolumetricMaxPooling_updateGradInput", (PyCFunction)DoubleVolumetricMaxPooling_updateGradInput, METH_STATIC | METH_VARARGS, NULL},
