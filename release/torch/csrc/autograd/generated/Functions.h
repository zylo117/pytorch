...
struct DiagonalBackward : public Function {
  using Function::Function;
  variable_list apply(const variable_list& grads) override;
  std::string name() override { return "DiagonalBackward"; }
  void release_variables() override {
...
struct GesvSingleBackward : public TraceableFunction {
  using TraceableFunction::TraceableFunction;
  variable_list apply(const variable_list& grads) override;
  std::string name() override { return "GesvSingleBackward"; }
  void release_variables() override {
    self_.reset_data();
    A_.reset_data();
...
struct GesvHelperBackward : public TraceableFunction {
  using TraceableFunction::TraceableFunction;
  variable_list apply(const variable_list& grads) override;
  std::string name() override { return "GesvHelperBackward"; }
  void release_variables() override {
    self_.reset_data();
    A_.reset_data();
    result0_.reset_data();
...
struct LogsumexpBackward : public TraceableFunction {
  using TraceableFunction::TraceableFunction;
  variable_list apply(const variable_list& grads) override;
  std::string name() override { return "LogsumexpBackward"; }
  void release_variables() override {
    self_.reset_data();
    result_.reset_data();
  }
...
struct LogSoftmaxBackwardDataBackward : public TraceableFunction {
  using TraceableFunction::TraceableFunction;
  variable_list apply(const variable_list& grads) override;
  std::string name() override { return "LogSoftmaxBackwardDataBackward"; }
  void release_variables() override {
    output_.reset_data();
    grad_output_.reset_data();
  }
...
struct SoftmaxBackwardDataBackward : public TraceableFunction {
  using TraceableFunction::TraceableFunction;
  variable_list apply(const variable_list& grads) override;
  std::string name() override { return "SoftmaxBackwardDataBackward"; }
  void release_variables() override {
    output_.reset_data();
    self_.reset_data();
    grad_output_.reset_data();
