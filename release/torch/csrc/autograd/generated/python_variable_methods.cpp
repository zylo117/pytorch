...
static PyObject * THPVariable__abs(PyObject* self, PyObject* args)
{
  HANDLE_TH_ERRORS
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  return wrap(dispatch__abs(self_));
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable__acos(PyObject* self, PyObject* args)
{
  HANDLE_TH_ERRORS
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  return wrap(dispatch__acos(self_));
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable__argmax(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "_argmax(int64_t dim, bool keepdim=False)",
  }, /*traceable=*/true);
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  ParsedArgs<3> parsed_args;
  auto r = parser.parse(args, kwargs, parsed_args);
  if (r.idx == 0) {
    return wrap(dispatch__argmax(self_, r.toInt64(0), r.toBool(1)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable__argmin(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "_argmin(int64_t dim, bool keepdim=False)",
  }, /*traceable=*/true);
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  ParsedArgs<3> parsed_args;
  auto r = parser.parse(args, kwargs, parsed_args);
  if (r.idx == 0) {
    return wrap(dispatch__argmin(self_, r.toInt64(0), r.toBool(1)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable__asin(PyObject* self, PyObject* args)
{
  HANDLE_TH_ERRORS
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  return wrap(dispatch__asin(self_));
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable__atan(PyObject* self, PyObject* args)
{
  HANDLE_TH_ERRORS
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  return wrap(dispatch__atan(self_));
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable__cast_Half(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "_cast_Half(bool non_blocking=False)",
  }, /*traceable=*/true);
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  ParsedArgs<2> parsed_args;
  auto r = parser.parse(args, kwargs, parsed_args);
  if (r.idx == 0) {
    return wrap(dispatch__cast_Half(self_, r.toBool(0)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable__cast_double(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "_cast_double(bool non_blocking=False)",
  }, /*traceable=*/true);
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  ParsedArgs<2> parsed_args;
  auto r = parser.parse(args, kwargs, parsed_args);
  if (r.idx == 0) {
    return wrap(dispatch__cast_double(self_, r.toBool(0)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable__cast_float(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "_cast_float(bool non_blocking=False)",
  }, /*traceable=*/true);
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  ParsedArgs<2> parsed_args;
  auto r = parser.parse(args, kwargs, parsed_args);
  if (r.idx == 0) {
    return wrap(dispatch__cast_float(self_, r.toBool(0)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable__cast_int(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "_cast_int(bool non_blocking=False)",
  }, /*traceable=*/true);
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  ParsedArgs<2> parsed_args;
  auto r = parser.parse(args, kwargs, parsed_args);
  if (r.idx == 0) {
    return wrap(dispatch__cast_int(self_, r.toBool(0)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable__cast_int16_t(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "_cast_int16_t(bool non_blocking=False)",
  }, /*traceable=*/true);
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  ParsedArgs<2> parsed_args;
  auto r = parser.parse(args, kwargs, parsed_args);
  if (r.idx == 0) {
    return wrap(dispatch__cast_int16_t(self_, r.toBool(0)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable__cast_int64_t(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "_cast_int64_t(bool non_blocking=False)",
  }, /*traceable=*/true);
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  ParsedArgs<2> parsed_args;
  auto r = parser.parse(args, kwargs, parsed_args);
  if (r.idx == 0) {
    return wrap(dispatch__cast_int64_t(self_, r.toBool(0)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable__cast_int8_t(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "_cast_int8_t(bool non_blocking=False)",
  }, /*traceable=*/true);
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  ParsedArgs<2> parsed_args;
  auto r = parser.parse(args, kwargs, parsed_args);
  if (r.idx == 0) {
    return wrap(dispatch__cast_int8_t(self_, r.toBool(0)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable__cast_uint8_t(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "_cast_uint8_t(bool non_blocking=False)",
  }, /*traceable=*/true);
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  ParsedArgs<2> parsed_args;
  auto r = parser.parse(args, kwargs, parsed_args);
  if (r.idx == 0) {
    return wrap(dispatch__cast_uint8_t(self_, r.toBool(0)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable__ceil(PyObject* self, PyObject* args)
{
  HANDLE_TH_ERRORS
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  return wrap(dispatch__ceil(self_));
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable__cos(PyObject* self, PyObject* args)
{
  HANDLE_TH_ERRORS
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  return wrap(dispatch__cos(self_));
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable__cosh(PyObject* self, PyObject* args)
{
  HANDLE_TH_ERRORS
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  return wrap(dispatch__cosh(self_));
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable__erf(PyObject* self, PyObject* args)
{
  HANDLE_TH_ERRORS
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  return wrap(dispatch__erf(self_));
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable__exp(PyObject* self, PyObject* args)
{
  HANDLE_TH_ERRORS
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  return wrap(dispatch__exp(self_));
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable__expm1(PyObject* self, PyObject* args)
{
  HANDLE_TH_ERRORS
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  return wrap(dispatch__expm1(self_));
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable__fft_with_size(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "_fft_with_size(int64_t signal_ndim, bool complex_input, bool complex_output, bool inverse, IntList checked_signal_sizes, bool normalized, bool onesided, IntList output_sizes)",
  }, /*traceable=*/true);
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  ParsedArgs<9> parsed_args;
  auto r = parser.parse(args, kwargs, parsed_args);
  if (r.idx == 0) {
    return wrap(dispatch__fft_with_size(self_, r.toInt64(0), r.toBool(1), r.toBool(2), r.toBool(3), r.intlist(4), r.toBool(5), r.toBool(6), r.intlist(7)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable__fill_(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "_fill_(Tensor value)",
  ...
  auto r = parser.parse(args, kwargs, parsed_args);
  if (r.idx == 0) {
    return wrap(dispatch__fill_(self_, r.tensor(0)));
  } else if (r.idx == 1) {
    return wrap(dispatch__fill_(self_, r.scalar(0)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable__floor(PyObject* self, PyObject* args)
{
  HANDLE_TH_ERRORS
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  return wrap(dispatch__floor(self_));
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable__log(PyObject* self, PyObject* args)
{
  HANDLE_TH_ERRORS
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  return wrap(dispatch__log(self_));
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable__log10(PyObject* self, PyObject* args)
{
  HANDLE_TH_ERRORS
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  return wrap(dispatch__log10(self_));
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable__log1p(PyObject* self, PyObject* args)
{
  HANDLE_TH_ERRORS
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  return wrap(dispatch__log1p(self_));
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable__log2(PyObject* self, PyObject* args)
{
  HANDLE_TH_ERRORS
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  return wrap(dispatch__log2(self_));
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable__round(PyObject* self, PyObject* args)
{
  HANDLE_TH_ERRORS
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  return wrap(dispatch__round(self_));
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable__rsqrt(PyObject* self, PyObject* args)
{
  HANDLE_TH_ERRORS
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  return wrap(dispatch__rsqrt(self_));
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable__sin(PyObject* self, PyObject* args)
{
  HANDLE_TH_ERRORS
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  return wrap(dispatch__sin(self_));
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable__sinh(PyObject* self, PyObject* args)
{
  HANDLE_TH_ERRORS
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  return wrap(dispatch__sinh(self_));
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable__sqrt(PyObject* self, PyObject* args)
{
  HANDLE_TH_ERRORS
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  return wrap(dispatch__sqrt(self_));
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable__tan(PyObject* self, PyObject* args)
{
  HANDLE_TH_ERRORS
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  return wrap(dispatch__tan(self_));
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable__th_bernoulli(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "_th_bernoulli(*, Generator generator=None)",
  }, /*traceable=*/false);
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  ParsedArgs<2> parsed_args;
  auto r = parser.parse(args, kwargs, parsed_args);
  if (r.idx == 0) {
    return wrap(dispatch__th_bernoulli(self_, r.generator(0)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable__th_tanh(PyObject* self, PyObject* args)
{
  HANDLE_TH_ERRORS
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  return wrap(dispatch__th_tanh(self_));
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable__trunc(PyObject* self, PyObject* args)
{
  HANDLE_TH_ERRORS
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  return wrap(dispatch__trunc(self_));
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable__unique(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "_unique(bool sorted=False, bool return_inverse=False)",
  }, /*traceable=*/true);
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  ParsedArgs<3> parsed_args;
  auto r = parser.parse(args, kwargs, parsed_args);
  if (r.idx == 0) {
    return wrap(dispatch__unique(self_, r.toBool(0), r.toBool(1)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_all(PyObject* self, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    ...
    return wrap(dispatch_all(self_, r.toInt64(0), r.toBool(1)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable_allclose(PyObject* self, PyObject* args, PyObject* kwargs)
{
  ...
  auto r = parser.parse(args, kwargs, parsed_args);
  if (r.idx == 0) {
    return wrap(dispatch_allclose(self_, r.tensor(0), r.toDouble(1), r.toDouble(2), r.toBool(3)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable_any(PyObject* self, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    ...
    return wrap(dispatch_any(self_, r.toInt64(0), r.toBool(1)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_bernoulli(PyObject* self, PyObject* args, PyObject* kwargs)
{
  ...
  static PythonArgParser parser({
    "bernoulli()",
    "bernoulli(Tensor p, Generator generator=None)",
  ...
  auto r = parser.parse(args, kwargs, parsed_args);
  if (r.idx == 0) {
    return wrap(dispatch_bernoulli(self_));
  } else if (r.idx == 1) {
    return wrap(dispatch_bernoulli(self_, r.tensor(0), r.generator(1)));
  } else if (r.idx == 2) {
    return wrap(dispatch_bernoulli(self_, r.toDouble(0), r.generator(1)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable_bernoulli_(PyObject* self, PyObject* args, PyObject* kwargs)
{
  ...
  static PythonArgParser parser({
    ...
    "bernoulli_(double p, Generator generator=None)",
  }, /*traceable=*/false);
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  ParsedArgs<3> parsed_args;
  auto r = parser.parse(args, kwargs, parsed_args);
  if (r.idx == 0) {
    return wrap(dispatch_bernoulli_(self_));
  } else if (r.idx == 1) {
...
static PyObject * THPVariable_cumprod(PyObject* self, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    ...
    return wrap(dispatch_cumprod(self_, r.toInt64(0), r.scalartype(1)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable_cumsum(PyObject* self, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    ...
    return wrap(dispatch_cumsum(self_, r.toInt64(0), r.scalartype(1)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_diagonal(PyObject* self, PyObject* args, PyObject* kwargs)
{
  ...
  auto r = parser.parse(args, kwargs, parsed_args);
  if (r.idx == 0) {
    return wrap(dispatch_diagonal(self_, r.toInt64(0), r.toInt64(1), r.toInt64(2)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_expand(PyObject* self, PyObject* args, PyObject* kwargs)
{
  ...
  auto r = parser.parse(args, kwargs, parsed_args);
  if (r.idx == 0) {
    return wrap(dispatch_expand(self_, r.intlist(0), r.toBool(1)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_fft(PyObject* self, PyObject* args, PyObject* kwargs)
{
  ...
  auto r = parser.parse(args, kwargs, parsed_args);
  if (r.idx == 0) {
    return wrap(dispatch_fft(self_, r.toInt64(0), r.toBool(1)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_ifft(PyObject* self, PyObject* args, PyObject* kwargs)
{
  ...
  auto r = parser.parse(args, kwargs, parsed_args);
  if (r.idx == 0) {
    return wrap(dispatch_ifft(self_, r.toInt64(0), r.toBool(1)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_irfft(PyObject* self, PyObject* args, PyObject* kwargs)
{
  ...
  auto r = parser.parse(args, kwargs, parsed_args);
  if (r.idx == 0) {
    return wrap(dispatch_irfft(self_, r.toInt64(0), r.toBool(1), r.toBool(2), r.intlist(3)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_isclose(PyObject* self, PyObject* args, PyObject* kwargs)
{
  ...
  auto r = parser.parse(args, kwargs, parsed_args);
  if (r.idx == 0) {
    return wrap(dispatch_isclose(self_, r.tensor(0), r.toDouble(1), r.toDouble(2), r.toBool(3)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_log10(PyObject* self, PyObject* args)
{
  HANDLE_TH_ERRORS
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  return wrap(dispatch_log10(self_));
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable_log10_(PyObject* self, PyObject* args)
{
  HANDLE_TH_ERRORS
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  return wrap(dispatch_log10_(self_));
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_log2(PyObject* self, PyObject* args)
{
  HANDLE_TH_ERRORS
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  return wrap(dispatch_log2(self_));
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable_log2_(PyObject* self, PyObject* args)
{
  HANDLE_TH_ERRORS
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  return wrap(dispatch_log2_(self_));
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_log_softmax(PyObject* self, PyObject* args, PyObject* kwargs)
{
  ...
  auto r = parser.parse(args, kwargs, parsed_args);
  if (r.idx == 0) {
    return wrap(dispatch_log_softmax(self_, r.toInt64(0)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable_log_softmax_backward_data(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "log_softmax_backward_data(Tensor grad_output, Tensor output, int64_t dim, )",
  }, /*traceable=*/true);
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  ParsedArgs<4> parsed_args;
  auto r = parser.parse(args, kwargs, parsed_args);
  if (r.idx == 0) {
    return wrap(dispatch_log_softmax_backward_data(r.tensor(0), r.tensor(1), r.toInt64(2), self_));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable_logdet(PyObject* self, PyObject* args)
{
  HANDLE_TH_ERRORS
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  return wrap(dispatch_logdet(self_));
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable_logsumexp(PyObject* self, PyObject* args, PyObject* kwargs)
{
  ...
  auto r = parser.parse(args, kwargs, parsed_args);
  if (r.idx == 0) {
    return wrap(dispatch_logsumexp(self_, r.toInt64(0), r.toBool(1)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_prod(PyObject* self, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    ...
    return wrap(dispatch_prod(self_, r.scalartype(0)));
  } else if (r.idx == 2) {
    return wrap(dispatch_prod(self_, r.toInt64(0), r.scalartype(1)));
  } else if (r.idx == 3) {
    return wrap(dispatch_prod(self_, r.toInt64(0), r.toBool(1), r.scalartype(2)));
  } else if (r.idx == 4) {
...
static PyObject * THPVariable_relu(PyObject* self, PyObject* args)
{
  HANDLE_TH_ERRORS
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  return wrap(dispatch_relu(self_));
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable_relu_(PyObject* self, PyObject* args)
{
  HANDLE_TH_ERRORS
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  return wrap(dispatch_relu_(self_));
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_reshape(PyObject* self, PyObject* args, PyObject* kwargs)
{
  ...
  auto r = parser.parse(args, kwargs, parsed_args);
  if (r.idx == 0) {
    return wrap(dispatch_reshape(self_, r.intlist(0)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_rfft(PyObject* self, PyObject* args, PyObject* kwargs)
{
  ...
  auto r = parser.parse(args, kwargs, parsed_args);
  if (r.idx == 0) {
    return wrap(dispatch_rfft(self_, r.toInt64(0), r.toBool(1), r.toBool(2)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_slogdet(PyObject* self, PyObject* args)
{
  HANDLE_TH_ERRORS
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  return wrap(dispatch_slogdet(self_));
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_softmax(PyObject* self, PyObject* args, PyObject* kwargs)
{
  ...
  auto r = parser.parse(args, kwargs, parsed_args);
  if (r.idx == 0) {
    return wrap(dispatch_softmax(self_, r.toInt64(0)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable_softmax_backward_data(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "softmax_backward_data(Tensor grad_output, Tensor output, int64_t dim, )",
  }, /*traceable=*/true);
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  ParsedArgs<4> parsed_args;
  auto r = parser.parse(args, kwargs, parsed_args);
  if (r.idx == 0) {
    return wrap(dispatch_softmax_backward_data(r.tensor(0), r.tensor(1), r.toInt64(2), self_));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_split_with_sizes(PyObject* self, PyObject* args, PyObject* kwargs)
{
  ...
  auto r = parser.parse(args, kwargs, parsed_args);
  if (r.idx == 0) {
    return wrap(dispatch_split_with_sizes(self_, r.intlist(0), r.toInt64(1)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_stft(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "stft(int64_t frame_length, int64_t hop, int64_t fft_size=None, bool normalized=False, bool onesided=True, Tensor? window=None, int64_t pad_end=0)",
  }, /*traceable=*/true);
  auto& self_ = reinterpret_cast<THPVariable*>(self)->cdata;
  ...
  if (r.idx == 0) {
    ...
    auto normalized = r.toBool(3);
    auto onesided = r.toBool(4);
    auto window = r.tensor(5);
    auto pad_end = r.toInt64(6);
    return wrap(dispatch_stft(self_, frame_length, hop, fft_size, normalized, onesided, window, pad_end));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_sum(PyObject* self, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    ...
    return wrap(dispatch_sum(self_, r.scalartype(0)));
  } else if (r.idx == 2) {
    return wrap(dispatch_sum(self_, r.intlist(0), r.scalartype(1)));
  } else if (r.idx == 3) {
    return wrap(dispatch_sum(self_, r.intlist(0), r.toBool(1), r.scalartype(2)));
  } else if (r.idx == 4) {
    return wrap(dispatch_sum(self_, r.intlist(0), r.toBool(1)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
PyMethodDef variable_methods[] = {
  ...
  {"_abs", (PyCFunction)THPVariable__abs, METH_NOARGS, NULL},
  {"_acos", (PyCFunction)THPVariable__acos, METH_NOARGS, NULL},
  ...
  {"_argmax", (PyCFunction)THPVariable__argmax, METH_VARARGS | METH_KEYWORDS, NULL},
  {"_argmin", (PyCFunction)THPVariable__argmin, METH_VARARGS | METH_KEYWORDS, NULL},
  {"_asin", (PyCFunction)THPVariable__asin, METH_NOARGS, NULL},
  {"_atan", (PyCFunction)THPVariable__atan, METH_NOARGS, NULL},
  {"_cast_Half", (PyCFunction)THPVariable__cast_Half, METH_VARARGS | METH_KEYWORDS, NULL},
  {"_cast_double", (PyCFunction)THPVariable__cast_double, METH_VARARGS | METH_KEYWORDS, NULL},
  {"_cast_float", (PyCFunction)THPVariable__cast_float, METH_VARARGS | METH_KEYWORDS, NULL},
  {"_cast_int", (PyCFunction)THPVariable__cast_int, METH_VARARGS | METH_KEYWORDS, NULL},
  {"_cast_int16_t", (PyCFunction)THPVariable__cast_int16_t, METH_VARARGS | METH_KEYWORDS, NULL},
  {"_cast_int64_t", (PyCFunction)THPVariable__cast_int64_t, METH_VARARGS | METH_KEYWORDS, NULL},
  {"_cast_int8_t", (PyCFunction)THPVariable__cast_int8_t, METH_VARARGS | METH_KEYWORDS, NULL},
  {"_cast_uint8_t", (PyCFunction)THPVariable__cast_uint8_t, METH_VARARGS | METH_KEYWORDS, NULL},
  {"_ceil", (PyCFunction)THPVariable__ceil, METH_NOARGS, NULL},
  {"_copy_ignoring_overlaps_", (PyCFunction)THPVariable__copy_ignoring_overlaps_, METH_VARARGS | METH_KEYWORDS, NULL},
  {"_cos", (PyCFunction)THPVariable__cos, METH_NOARGS, NULL},
  {"_cosh", (PyCFunction)THPVariable__cosh, METH_NOARGS, NULL},
  ...
  {"_erf", (PyCFunction)THPVariable__erf, METH_NOARGS, NULL},
  {"_exp", (PyCFunction)THPVariable__exp, METH_NOARGS, NULL},
  {"_expm1", (PyCFunction)THPVariable__expm1, METH_NOARGS, NULL},
  {"_fft_with_size", (PyCFunction)THPVariable__fft_with_size, METH_VARARGS | METH_KEYWORDS, NULL},
  {"_fill_", (PyCFunction)THPVariable__fill_, METH_VARARGS | METH_KEYWORDS, NULL},
  {"_floor", (PyCFunction)THPVariable__floor, METH_NOARGS, NULL},
  ...
  {"_log", (PyCFunction)THPVariable__log, METH_NOARGS, NULL},
  {"_log10", (PyCFunction)THPVariable__log10, METH_NOARGS, NULL},
  {"_log1p", (PyCFunction)THPVariable__log1p, METH_NOARGS, NULL},
  {"_log2", (PyCFunction)THPVariable__log2, METH_NOARGS, NULL},
  ...
  {"_round", (PyCFunction)THPVariable__round, METH_NOARGS, NULL},
  {"_rsqrt", (PyCFunction)THPVariable__rsqrt, METH_NOARGS, NULL},
  {"_s_where", (PyCFunction)THPVariable__s_where, METH_VARARGS | METH_KEYWORDS, NULL},
  {"_sin", (PyCFunction)THPVariable__sin, METH_NOARGS, NULL},
  {"_sinh", (PyCFunction)THPVariable__sinh, METH_NOARGS, NULL},
  {"_sparse_mask", (PyCFunction)THPVariable__sparse_mask, METH_VARARGS | METH_KEYWORDS, NULL},
  {"_sqrt", (PyCFunction)THPVariable__sqrt, METH_NOARGS, NULL},
  ...
  {"_tan", (PyCFunction)THPVariable__tan, METH_NOARGS, NULL},
  {"_th_bernoulli", (PyCFunction)THPVariable__th_bernoulli, METH_VARARGS | METH_KEYWORDS, NULL},
  {"_th_tanh", (PyCFunction)THPVariable__th_tanh, METH_NOARGS, NULL},
  {"_trunc", (PyCFunction)THPVariable__trunc, METH_NOARGS, NULL},
  {"_unique", (PyCFunction)THPVariable__unique, METH_VARARGS | METH_KEYWORDS, NULL},
  ...
  {"log_softmax_backward_data", (PyCFunction)THPVariable_log_softmax_backward_data, METH_VARARGS | METH_KEYWORDS, NULL},
  ...
  {"softmax_backward_data", (PyCFunction)THPVariable_softmax_backward_data, METH_VARARGS | METH_KEYWORDS, NULL},
