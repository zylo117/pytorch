1. copy this to root CMakeLists.txt on about line 163 (because stupid CMakeLists considers "/usr/local/cuda/lib/stubs/cuda.framework" is cuda lib path instead of "/usr/local/cuda/lib")
